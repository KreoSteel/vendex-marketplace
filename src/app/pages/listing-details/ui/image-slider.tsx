...
export default function ImageSlider({ slides }: ImageSliderProps) {
   ...
   const safeCurrentIndex = currentIndex >= validSlides.length ? 0 : currentIndex;
   ...
   function goToPrevious() {
      ...
      const newIndex = isFirstSlide ? validSlides.length - 1 : safeCurrentIndex - 1;
      setCurrentIndex(newIndex);
   }

   function goToNext() {
      const isLastSlide = safeCurrentIndex === validSlides.length - 1;
      const newIndex = isLastSlide ? 0 : safeCurrentIndex + 1;
      setCurrentIndex(newIndex);
   }
   ...
   return (
      <div className="relative w-full h-full group">
         <div className="relative w-full h-full">
            <Image
               src={validSlides[safeCurrentIndex]}
